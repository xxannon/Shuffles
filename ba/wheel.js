...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Update shuffle button handler
    const shuffleButtonElement = document.querySelector('.shuffle-button');
    if (shuffleButtonElement) {
        shuffleButtonElement.addEventListener('click', shuffleNewRecipe);
        shuffleButtonElement.style.display = 'none';
    }
});
...
function flipCard() {
    ...
    if (!mealTypeDropdown || !mealTypeDropdown.value) {
